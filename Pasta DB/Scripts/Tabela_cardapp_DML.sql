...
INSERT INTO t_cpp_item_cardapio VALUES(1, 1, '1', 'Sorvete de Chocolate', '100g de sorvete sabor chocolate', 5.00, 'Leite, chocolate em pó e açúcar', 'SOBREMESA', 700,1);
INSERT INTO t_cpp_item_cardapio VALUES(2, 1, '0', 'Milk Shake de Menta com Chocolate', '150ml de sorvete sabor menta e chocolate', 7.00, 'Leite, menta e chocolate em pó e açúcar', 'SOBREMESA', 750,1);
INSERT INTO t_cpp_item_cardapio VALUES(3, 2, '1', 'Churros de Chocolate', '1 unidade de churros sabor chocolate', 7.00, 'Leite, chocolate, farinha de trigo, água e açúcar', 'SOBREMESA', 850, 1);
INSERT INTO t_cpp_item_cardapio VALUES(4, 2, '0', 'Churros de Doce de Leite', '1 unidade de churros sabor doce de leite', 7.00, 'Leite, doce de leite, farinha de trigo, água e açúcar', 'SOBREMESA', 800, 1);
INSERT INTO t_cpp_item_cardapio VALUES(5, 3, '1', 'Arroz', '100g de arroz do tipo 1', 3.00, 'Arroz Tipo 1', 'PRATO', 200, 1);
INSERT INTO t_cpp_item_cardapio VALUES(6, 3, '0', 'Feijão', '100g de feijão carioca', 4.00, 'Feijão Carioca', 'PRATO', 300, 1);
insert into t_cpp_item_cardapio values(7, 1, '1', 'Milkshake unicórnio','Com MeMs', 8.00, 'Leite, chocolate, caramelo, chantilly e MeM','SOBREMESA', 500, 1);
...
insert into t_cpp_item_cardapio values(9, 2, '1', 'Cerveja pilsen','A melhor cerveja do MUNDO', 10.00, 'Lúpulo, cevada','BEBIDA', 43, 1);
...
insert into t_cpp_item_cardapio values(11, 3, '0', 'Vinho tinto espanhol','Quer ostentar? então toma, ano de 1930', 10000.00, 'Vinho tinto espanhol','BEBIDA', 0, 1);
insert into t_cpp_item_cardapio values(12, 3, '1', 'Virada à paulista','Venha comer esse clássico!', 15.00, 'Arroz, feijão, Bife, ovo frito, couve refogada e tomate.','PRATO', 400, 1);
insert into t_cpp_item_cardapio values(13, 3, '1', 'Lanche Cheddar Duplo','200g de hambúrguer artesanal e 100g de cheddar,', 20.00, 'Hambúrguer, alface, cheddar, tomate.','LANCHE', 500, 1);
